                            ...
                            <div class="single_section_content box blog_large_post_style">
                                <div class="jl_single_style2" id="generate-linkxx">
                                    <div class="single_post_entry_content single_bellow_left_align jl_top_single_title jl_top_title_feature">
                                        ...
                                        <span class="meta-category-small single_meta_category">
                                            <a class="post-category-color-text" style="background:#305b90" href="<?= base_url('web') ?>/transparansi-inovasi">Kembali</a>
                                        </span>
                                        <h6><span class="badge badge-light-primary"></span></h6>

                                        <div class="section-title">
                                            <h2 class=""><?= $transparansi->judul ?></h2>
                                        </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <ul class="entry__meta text-right">
                                                    <li class="entry__meta-date">
                                                        <span style="color:#305b90;"><?= $transparansi->created_at ?></span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </span>
                                    </div>
                                    <?php if ($transparansi->image !== NULL) { ?>
                                        <div class="single_content_header jl_single_feature_below">
                                            <div class="">
                                                <img width="1000" height="650" src="<?= base_url() ?>uploads/transparansi/<?= $transparansi->image ?>" class="" alt="" loading="lazy">
                                            </div>
                                        </div>
                                    <?php } ?>
                                </div>
                                            ...
                                            <div class="jl_single_share_wrapper jl_clear_at">
                                                <ul class="single_post_share_icon_post">
                                                    <li class="single_post_share_facebook">
                                                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?= base_url('web/transparansi') . '/' . $transparansi->url ?>" target="_blank"><i class="jli-facebook"></i>
                                                        </a>
                                                    </li>
                                                    <li class="single_post_share_twitter">
                                                        <a href="https://twitter.com/intent/tweet?url=<?= base_url('web/transparansi') . '/' . $transparansi->url ?>" target="_blank"><i class="jli-twitter"></i>
                                                        </a>
                                                    </li>
                                                    <li class="single_post_share_whatsapp">
                                                        <a href="whatsapp://send?text=<?= base_url('web/transparansi') . '/' . $transparansi->url ?>" target="_blank"><i class="fab fa-whatsapp"></i>
                                                        </a>
                                                    </li>
                                ...
                                <?php if ($transparansi->lampiran !== NULL) { ?>
                                    <div class="single_tag_share ">
                                        <div class="tag-cat">
                                            <ul class="single_post_tag_layout">
                                                <li>
                                                    <a target="_blank" href="<?= base_url('uploads/transparansi') . '/' . $transparansi->lampiran ?>">Download Lampiran</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
