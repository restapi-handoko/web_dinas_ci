                ...
                <div class="col-md-8 col-sm-12">
                    <div class="section-title">
                        <h1 class="d-flex justify-content-between">
                            <a class="text-uppercase">Daftar Transparansi & Inovasi</a>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12 col-12">
                            <div class="entry-content">
                                ...
                                <?php if (isset($dataTransparansi)) { ?>
                                    <?php if (count($dataTransparansi) > 0) { ?>
                                        <?php foreach ($dataTransparansi as $key => $value) { ?>
                                            <div class="list-group mt-2">
                                                <div class="list-group-item list-group-item-action " onclick="lihattransparansi('<?= $value->url ?>')">
