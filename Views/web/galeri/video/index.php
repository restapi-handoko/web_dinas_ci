            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-12">
                    <div class="ettitle jl_cat_mid_title text-center widget-title">
                        <h4 class="categories-title title jl_title_c">Galeri Video </h4>
                    </div>
                    <div class="widget_jl_wrapper">
                        <div class="bt_post_widget">
                            <?php if (isset($dataVideo)) { ?>
                                <?php if (count($dataVideo) > 0) { ?>
                                    <?php foreach ($dataVideo as $key => $value) { ?>
                                        <div class="col-md-6">
                                            <div class="card-mod jl_grid_w">
                                                <div class="jl_img_box jl_radus_e">
                                                    <!-- <a href="https://www.youtube.com/embed/e3Ul4b-nYko"> <span class="jl_post_type_icon"><i class="jli-youtube"></i></span>
                                                        <img width="500" height="350" src="https://img.youtube.com/vi/BO8gSLYXFsg/maxresdefault.jpg" class="attachment-sprasa_slider_grid_small size-sprasa_slider_grid_small wp-post-image" alt="Ahimsa Wujud Dari Moderasi Beragama" loading="lazy">
                                                    </a> -->
                                                    <a href="<?= $value->url_video ?>" target="_blank">
                                                        <iframe width="260" height="200" class="embed-responsive-item" src="<?= $value->url_video ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen alt="img">
                                                        </iframe>
                                                    </a>
                                                </div>
                                                <div class="video-text mt-3">
                                                    <h3><a href="<?= $value->url_video ?>" target="_blank"><?= $value->judul ?></a></h3>
                                                    <!-- <span class="jl_post_meta">
                                                        <span class="post-date">Senin, 1 Oktober 2022 14:43 WIB</span>
                                                    </span> -->
                                                </div>
                                            </div>
                                        </div>
