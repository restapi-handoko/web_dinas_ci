                ...
                <div class="col-md-8 col-sm-12">
                    <div class="section-title">
                        <h1 class="d-flex justify-content-between">
                            <a class="text-uppercase">Bank Data</a>
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php if (isset($dataDokumen)) { ?>
                                                    <?php if (count($dataDokumen) > 0) { ?>
                                                        <?php foreach ($dataDokumen as $key => $value) { ?>
                                                            <tr>
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            ...
                                            <?php if ($pagination['currentPage'] > 1): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="<?= base_url('web') ?>/bankdata?page=1" aria-label="First">
                                            ...
                                            <?php if ($pagination['currentPage'] > 1): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="<?= base_url('web') ?>/bankdata?page=<?= $pagination['currentPage'] - 1 ?>" aria-label="Previous">
                                                        <span aria-hidden="true">‹</span>
                                                    </a>
                                                </li>
                                            <?php else: ?>
                                            ...
                                            <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                                                <li class="page-item <?= $i == $pagination['currentPage'] ? 'active' : '' ?>">
                                                    <a class="page-link" href="<?= base_url('web') ?>/bankdata?page=<?= $i ?>">
                                                        <?= $i ?>
                                                    </a>
                                                </li>
                                            <?php endfor; ?>
                                            ...
                                            <?php if ($pagination['currentPage'] < $pagination['totalPages']): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="<?= base_url('web') ?>/bankdata?page=<?= $pagination['currentPage'] + 1 ?>" aria-label="Next">
                                                        <span aria-hidden="true">›</span>
                                                    </a>
                                                </li>
                                            <?php else: ?>
                                            ...
                                            <?php if ($pagination['currentPage'] < $pagination['totalPages']): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="<?= base_url('web') ?>/bankdata?page=<?= $pagination['totalPages'] ?>" aria-label="Last">
                                                        <span aria-hidden="true">»</span>
                                                    </a>
                                                </li>
                                            <?php else: ?>
