                ...
                <div class="col-md-8 col-sm-12">
                    <div class="section-title">
                        <h1 class="d-flex justify-content-between">
                            <a class="text-uppercase">Produk Hukum</a>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="entry-content">
                                ...
                                <div class="alert p-2 shadow-sm" style='background-color:#AFEEEE; border-color:#e3e3e3;'>
                                    ...
                                    Jika data yang dicari tidak ditemukan, Silahkan klik <a href="kritiksaran.html"><b>disini</b></a>, untuk melakukan permintaan Informasi.
                                                    ...
                                                    <?php if (count($dataProdukHukum) > 0) { ?>
                                                        <?php foreach ($dataProdukHukum as $key => $value) { ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <span style="font-size: 12px"><?= $value->kategori ?></span>
                                                                </td>
                                                                <td class="text-center">
                                                                    <span style="font-size: 12px"><?= $value->tahun ?></span>
                                                                </td>
                                                                <td class="text-center">
                                                                    <span style="font-size: 12px"><?= $value->nomor ?></span>
                                                                </td>
                                                                <td class="text-center">
                                                                    <span class="text-primary" style="font-size: 12px"><?= $value->judul ?></span>
                                                                </td>

                                                                <td class="text-center">
                                                                    <a target="_blank" href="<?= base_url('uploads/regulasi') . '/' . $value->lampiran ?>"><span class="badge badge-primary"> <i class="fas fa-download"></i></span></a>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                    <?php } ?>
                                ...
                                <ul class="pagination">
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            ...
                                            <?php if ($pagination['currentPage'] > 1): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="<?= base_url('web') ?>/produkhukum?page=<?= $pagination['currentPage'] - 1 ?>" aria-label="Previous">
                                                        <span aria-hidden="true">‹</span>
                                                    </a>
                                                </li>
                                            <?php else: ?>
                                            ...
                                            <?php if ($pagination['currentPage'] < $pagination['totalPages']): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="<?= base_url('web') ?>/produkhukum?page=<?= $pagination['currentPage'] + 1 ?>" aria-label="Next">
                                                        <span aria-hidden="true">›</span>
                                                    </a>
                                                </li>
                                            <?php else: ?>
                                            ...
                                            <?php if ($pagination['currentPage'] < $pagination['totalPages']): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="<?= base_url('web') ?>/produkhukum?page=<?= $pagination['totalPages'] ?>" aria-label="Last">
                                                        <span aria-hidden="true">»</span>
                                                    </a>
                                                </li>
                                            <?php else: ?>
