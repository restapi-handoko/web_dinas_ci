...
<header id="masthead" class="site-header">
    <nav class="navbar header-nav navbar-expand-lg" style="background-color:<?= $footer->warna ?>">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbar">
                <ul id="primary-menu" class="navbar-nav ml-auto align-items-center">
                    ...
                    <li id="menu-item-149" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-149"><a class="nav-link" href="https://www.lapor.go.id/" target="_blank">E-Lapor</a></li>
