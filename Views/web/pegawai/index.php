                ...
                <div class="col-md-8 col-sm-12">
                    <div class="section-title">
                        <h1 class="d-flex justify-content-between">
                            <a class="text-uppercase">Data Pegawai</a>
                                            ...
                                            <div class="col-md-4 mb-3 mb-md-3">
                                                <div class="card testimonial-card shadow-lg" style="border-style: solid;">
                                                    ...
                                                    <div class="avatar mx-auto bg-white">
                                                        <img src="<?= base_url() ?>uploads/pegawai/<?= $value->image ?>" class="rounded-circle img-fluid" style="width: 180px;" />
                                                    </div>
                                                    <div class="card-body">
                                                        <strong><a style="font-size: 16px;"><?= $value->fullname ?></a></strong>
                                                        <p class="mb-2 pb-1" style="color: #2b2a2a;"><?= $value->jabatan ?></p>
                                                        <p class="mb-2 pb-1" style="color: #2b2a2a;">NIP. <?= $value->nip ?></p>
                                                        <hr />
                                                        <center>
                                                            <button type="button" class="btn btn-primary p-0 " onclick="lihatpegawai('<?= $value->pid ?>')">&nbsp;<i class="fas fa-chalkboard-teacher"></i> Lihat Detail &nbsp;</button>
                                                        </center>
                                ...
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item active">
                                            <a class="page-link" href="pegawai%3Fpage_hal=1.html">
                                                1 </a>
                                        </li>
                                        <li class="page-item ">
                                            <a class="page-link" href="pegawai%3Fpage_hal=2.html">
                                                2 </a>
                                        </li>

                                        <li class="page-item">
                                            <a class="page-link" href="pegawai%3Fpage_hal=2.html" aria-label="Next">
                                                <span aria-hidden="true">›</span>

                                            </a>
                                        </li>
                                        <li class="page-item">
                                            <a class="page-link" href="pegawai%3Fpage_hal=2.html" aria-label="Last">
                                                <span aria-hidden="true">»</span>
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            ...
                                            <?php if ($pagination['currentPage'] > 1): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="<?= base_url('web') ?>/pegawai?page=1" aria-label="First">
                                                        <span aria-hidden="true">«</span>
                                                    </a>
                                                </li>
                                            <?php else: ?>
                                            ...
                                            <?php if ($pagination['currentPage'] > 1): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="<?= base_url('web') ?>/pegawai?page=<?= $pagination['currentPage'] - 1 ?>" aria-label="Previous">
                                                        <span aria-hidden="true">‹</span>
                                                    </a>
                                                </li>
                                            <?php else: ?>
                                            ...
                                            <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                                                <li class="page-item <?= $i == $pagination['currentPage'] ? 'active' : '' ?>">
                                                    <a class="page-link" href="<?= base_url('web') ?>/pegawai?page=<?= $i ?>">
                                                        <?= $i ?>
                                                    </a>
                                                </li>
                                            <?php endfor; ?>
                                            ...
                                            <?php if ($pagination['currentPage'] < $pagination['totalPages']): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="<?= base_url('web') ?>/pegawai?page=<?= $pagination['currentPage'] + 1 ?>" aria-label="Next">
                                                        <span aria-hidden="true">›</span>
                                                    </a>
                                                </li>
                                            <?php else: ?>
                                            ...
                                            <?php if ($pagination['currentPage'] < $pagination['totalPages']): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="<?= base_url('web') ?>/pegawai?page=<?= $pagination['totalPages'] ?>" aria-label="Last">
                                                        <span aria-hidden="true">»</span>
                                                    </a>
                                                </li>
                                            <?php else: ?>
