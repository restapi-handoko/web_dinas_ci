    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-lg-2">
                ...
                <input type="date" class="form-control tanggal_mulai" id="_tanggal" name="_tanggal" onfocusin="inputFocus(this);" required />
                <div class="help-block _tanggal"></div>
            </div>
            <div class="col-lg-2">
                <label for="_tanggal_selesai" class="col-form-label">Tanggal Selesai:</label>
                <input type="date" class="form-control tanggal_selesai" id="_tanggal_selesai" name="_tanggal_selesai" onfocusin="inputFocus(this);" required />
                <div class="help-block _tanggal_selesai"></div>
            </div>
            <div class="col-lg-2">
                <label for="_jam" class="col-form-label">Jam:</label>
                <input type="time" class="form-control jam" id="_jam" name="_jam" onfocusin="inputFocus(this);" required />
            ...
            <div class="col-lg-12">
                ...
                <input type="text" class="form-control isi" id="_isi" name="_isi" placeholder="Tempat..." onfocusin="inputFocus(this);">
            ...
            <div class="col-lg-10">
                ...
                <input type="text" class="form-control penyelenggara" id="_penyelenggara" name="_penyelenggara" placeholder="Penyelenggara..." onfocusin="inputFocus(this);">
