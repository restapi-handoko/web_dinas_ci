                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <?php if (listHakAksesCustomAllowNew('informasi', 'pengadaan', 'add')) { ?>
...
<script>
    ...
    function actionHapus(event, title = "") {
        <?php if (listHakAksesCustomAllowNew('informasi', 'pengadaan', 'delete')) { ?>
            Swal.fire({
                title: 'Apakah anda yakin ingin menghapus data ini?',
                text: "Hapus pengadaan : " + title,
    ...
    function actionEdit(event, title) {
        <?php if (listHakAksesCustomAllowNew('informasi', 'pengadaan', 'edit')) { ?>
            $.ajax({
                url: "./edit",
                type: 'POST',
                data: {
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('EDIT PENGADAAN ' + title);
    ...
    function actionDetail(event, title) {
        <?php if (listHakAksesCustomAllowNew('informasi', 'pengadaan', 'detail')) { ?>
            $.ajax({
                url: "./detail",
                type: 'POST',
                data: {
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('DETAIL PENGADAAN ' + title);
                        $('.contentBodyModal').html(resul.data);
                        $('.content-detailModal').modal({
                            backdrop: 'static',
                            keyboard: false,
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('TAMBAH PENGADAAN');
                    $('.contentBodyModal').html(resul.data);
                    $('.content-detailModal').modal({
                        backdrop: 'static',
                        keyboard: false,
