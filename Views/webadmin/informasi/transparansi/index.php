        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Transparansi & Inovasi</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Transparansi & Inovasi</h4>
                            </div>
                            <?php if (listHakAksesCustomAllowNew('informasi', 'transparansi', 'add')) { ?>
...
<script>
    ...
    function actionHapus(event, title = "") {
        <?php if (listHakAksesCustomAllowNew('informasi', 'transparansi', 'delete')) { ?>
            Swal.fire({
                title: 'Apakah anda yakin ingin menghapus data ini?',
                text: "Hapus transparansi : " + title,
    ...
    function actionDetail(event, title) {
        <?php if (listHakAksesCustomAllowNew('informasi', 'transparansi', 'detail')) { ?>
            $.ajax({
                url: "./detail",
                type: 'POST',
                data: {
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('DETAIL TRANSPARANSI ' + title);
    ...
    function actionEdit(event, title) {
        <?php if (listHakAksesCustomAllowNew('informasi', 'transparansi', 'edit')) { ?>
            $.ajax({
                url: "./edit",
                type: 'POST',
                data: {
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('EDIT TRANSPARANSI ' + title);
                        $('.contentBodyModal').html(resul.data);
                        $('.content-detailModal').modal({
                            backdrop: 'static',
                            keyboard: false,
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('TAMBAH TRANSPARANSI');
                    $('.contentBodyModal').html(resul.data);
                    $('.content-detailModal').modal({
                        backdrop: 'static',
                        keyboard: false,
