        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-lg-10">
                    ...
                    <input type="text" class="form-control judul" value="<?= $data->judul ?>" id="_judul" name="_judul" placeholder="Judul Transparansi..." onfocusin="inputFocus(this);">
                            ...
                            <div class="form-group">
                                <div class="preview-image-upload">
                                    <?php if ($data->image !== null) { ?>
                                        <img class="imagePreviewUpload" src="<?= base_url('uploads/Transparansi') . '/' . $data->image ?>" id="imagePreviewUpload" />
                                    <?php } else { ?>
                            ...
                            <div class="form-group">
                                <div class="preview-image-upload">
                                    <?php if ($data->lampiran !== null) { ?>
                                        <a target="_blank" href="<?= base_url() . '/uploads/transparansi/' . $data->lampiran ?>" class="badge badge-pill badge-soft-success">Lampiran Transparansi</a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
