                        ...
                        <div class="row">
                            ...
                            <?php if (listHakAksesCustomAllowNew('web', 'sejarah', 'edit')) { ?>
                                <div class="col-6 text-end">
                                    <a href="<?= base_url('webadmin/web/sejarah/edit') ?>" class="btn btn-primary btn-rounded waves-effect waves-light" style="min-width: 6rem;"><i class="bx bx-edit font-size-16 align-middle me-2"></i> Edit </a>
                                </div>
                            <?php } ?>
                        </div>
