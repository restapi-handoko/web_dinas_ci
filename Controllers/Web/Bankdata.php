...
class Bankdata extends BaseController
{
    ...
    public function index()
    {
        ...
        $countBerita = $this->_db->table('_tb_dokumen')->where('status', 1)->countAllResults();
        $perPage = 10;
        ...
        $data['dataDokumen'] = $this->_db->table('_tb_dokumen a')
            ->select("a.*")
            ->where('a.status', 1)
            ->orderBy('a.created_at', 'DESC')
        ...
        return view('web/bankdata/index', $data);
    }
    ...
    public function detail($url)
    {
        ...
        $data['dataWidgetPengumuman'] = $this->_db->table('_tb_pengumuman a')
            ...
            ->get()
            ->getResult();
        return view('web/bankdata/detail', $data);
    }
}
