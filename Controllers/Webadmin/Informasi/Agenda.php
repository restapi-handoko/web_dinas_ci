...
use App\Models\Webadmin\Informasi\AgendaModel;
use Config\Services;
...
class Agenda extends BaseController
{
    ...
    {
        return redirect()->to(base_url('webadmin/informasi/agenda/data'));
    }
    ...
    public function data()
    {
        ...
        return view('webadmin/informasi/agenda/index', $data);
    }
    ...
    public function add()
    {
        ...
        $response->status = 200;
        $response->message = "Permintaan diizinkan";
        $response->data = view('webadmin/informasi/agenda/add');
        return json_encode($response);
    }
    ...
    public function edit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('webadmin/informasi/agenda/edit', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('webadmin/informasi/agenda/detail', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
